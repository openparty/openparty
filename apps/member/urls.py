...
urlpatterns = [
    ...
    re_path(r'request_reset_password$', MemberRequestResetPasswordView.as_view(), name='member_request_reset_pwd'),
    re_path(r'request_reset_password_done$', MemberRequestResetPasswordDone.as_view(), name='member_request_reset_pwd_done'),
    re_path(r'reset_password/(?P<user_id>\d+)/(?P<pwd_reset_token>\w+)/$', reset_password, name='reset_password'),
]
