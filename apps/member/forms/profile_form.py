...
class ProfileForm(forms.Form):
    ...
    gender = forms.ChoiceField(
        label=u"性别/Gender",
        required=True,
        choices=((u"男", u"男"), (u"女", u"女"), (u"中性", u"中性")),
        widget=forms.Select(attrs={"tabindex": "2"}),
    )
    career_years = forms.ChoiceField(
        label=u"工作年限/Career",
        required=True,
        choices=((u"1-3年", u"1-3年"), (u"3-5年", u"3-5年"), (u"5年以上", u"5年以上")),
        widget=forms.Select(attrs={"tabindex": "3"}),
    )
    ...
    blog = forms.CharField(
        ...
        required=False,
        max_length=255,
        widget=forms.TextInput(attrs={"tabindex": "6"}),
    )
    ...
    def __init__(self, user=None, *args, **kwargs):
        self.user = user
        self.member = user = self.user.profile
