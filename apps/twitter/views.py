...
def index(request):
    ...
    if hasattr(request, "user"):
        ...
        admin_mail_sha1_hash = (
            "c4a1f1d86ccd8981e9ea8cb3027c848d362bacd4",  # cnborn
...
def request_oauth(request):
    ...
    try:
        ...
        return render(
            request, "index.html", {"error_message": u"无法从twitter.com获取redirect url"}
        )
...
def oauth_callback(request):
    ...
    try:
        auth.set_request_token(
            member.twitter_access_token_key, member.twitter_access_token_secret
        )
